...
template < typename D, std::size_t I > class Nth
    : public Nth < pop_front < D >, I - 1 >
{
};

////////////////////////////////////////////////////////////////////////////////////////////////

template < typename D > class Nth < D, 0 >
    : public Front < D >
{
};
...
int main()
{
    static_assert(size_v < Deque <     > > == 0);
    static_assert(size_v < Deque < int > > == 1);
...
//  ------------------------------------------------------------------------------------------
    ...
    static_assert(std::is_same_v < nth < Deque < int, double >, 0 >, int    >);
    static_assert(std::is_same_v < nth < Deque < int, double >, 1 >, double >);
...
//  ------------------------------------------------------------------------------------------
    ...
    static_assert(has_v < int,    Deque < int, double, char > >);
